...
export interface DigitalAsset { id: string; title: string; type: 'video' | 'image' | 'template' | 'pdf' | 'ppt' | 'word'; category?: string; tags?: string[]; priceType: 'free' | 'sale'; price: number; fileUrl: string; description: string; date: string; downloadCount: number; }
